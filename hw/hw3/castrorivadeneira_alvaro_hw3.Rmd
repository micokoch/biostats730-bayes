...
First the notation:
We assume that for our prediction, the hierarchical sampling distribution holds true, where we want to predict the age at first marriage for a rondomly sampled woman $k$, in a new, unsampled ethnic group $h = j[k]$, that follows the distribution:
